...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      canEditTodo: false,
      canEditGroup: false,
      canShowListMenu: false,
      canShowGroupMenu: false,
      canShowTodoMenu: false,
      groupName: null,
      todoName: null,
      checked: []
    };
  ...
  methods: {
    showGroupCreate: function showGroupCreate() {
      var _this2 = this;

      this.canCreateGroup = !this.canCreateGroup;
      this.canShowListMenu = !this.canShowListMenu;
      this.$nextTick(function () {
        return _this2.$refs.groupInput.focus();
      });
    },
    ...
    showGroupEdit: function showGroupEdit(group) {
      var _this4 = this;

      this.canShowGroupMenu = false;
      this.canEditGroup = group.id;
      this.groupName = group.name;
      this.$nextTick(function () {
        return _this4.$refs.groupInput[0].focus();
      });
    },
    editGroup: function editGroup(group, data) {
      var _this5 = this;

      this.$inertia.put(this.$route('groups.update', group), data, {
        preserveScroll: true
      }).then(function () {
        return _this5.reset();
      });
    ...
    removeGroup: function removeGroup(group) {
      this.$inertia["delete"](this.$route('groups.destroy', group), {
        preserveScroll: true
      });
    },
    showTodoCreate: function showTodoCreate(group) {
      var _this6 = this;

      this.todoName = null;
      this.canCreateTodo = group;
      this.$nextTick(function () {
        return _this6.$refs.todoInput[0].focus();
      });
    },
    createTodo: function createTodo(groupId) {
      var _this7 = this;

      var $url = groupId == 0 ? this.$route('todos.store') : this.$route('todos.store', groupId);
    ...
    createTodoAndOneMore: function createTodoAndOneMore(groupId) {
      var _this8 = this;
      ...
      this.$inertia.post($url, {
        ...
        return _this8.showTodoCreate(groupId);
      });
    },
    showTodoEdit: function showTodoEdit(todo) {
      var _this9 = this;

      this.canShowTodoMenu = false;
      this.canEditTodo = todo.id;
      this.todoName = todo.name;
      this.$nextTick(function () {
        return _this9.$refs.todoInput[0].focus();
      });
    },
    editTodo: function editTodo(todo, data) {
      var _this10 = this;

      this.$inertia.put(this.$route('todos.update', todo), data, {
        preserveScroll: true
      }).then(function () {
    ...
    removeTodo: function removeTodo(todo) {
      this.$inertia["delete"](this.$route('todos.destroy', todo), {
        preserveScroll: true
      });
    },
    reset: function reset() {
      this.canShowListMenu = false;
      this.canShowGroupMenu = false;
      this.canShowTodoMenu = false;
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Components/todos.vue?vue&type=template&id=0e23ef52&":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Components/todos.vue?vue&type=template&id=0e23ef52& ***!
  \********************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "bg-white min-h-screen p-10",
      staticStyle: { "background-color": "#F6F2EF" }
    },
    [
      _c(
        "div",
        {
          staticClass:
            "bg-white lg:w-4/5 max-w-4xl mx-auto p-8 rounded shadow w-full"
        },
        [
          _c("div", { staticClass: "flex items-center" }, [
            _c("div", { staticClass: "relative" }, [
              _c(
                ...
                {
                  staticClass:
                    "p-1 border-2 rounded border-transparent focus:border-blue-500",
                  on: {
                    click: function($event) {
                      _vm.canShowListMenu = !_vm.canShowListMenu
                    }
                  }
                },
                [
                  _c("icon", {
                    staticClass: "block w-6 h-6 fill-current text-gray-500",
                    attrs: { name: "menu" }
                  })
                ],
                1
              ...
              _vm.canShowListMenu
                ? _c("div", {
                    staticClass: "fixed inset-0 opacity-0 z-40",
                    on: { click: _vm.reset }
                  })
                : _vm._e(),
              _vm._v(" "),
              _vm.canShowListMenu
                ? _c(
                    ...
                    {
                      staticClass:
                        "absolute mt-2 py-2 w-48 bg-white rounded-lg shadow-xl z-50"
                    },
                    [
                      _c(
                        "button",
                        {
                          staticClass:
                            "block w-full text-left px-4 py-2 text-gray-800 hover:bg-indigo-500 hover:text-white",
                          on: { click: _vm.showGroupCreate }
                        },
                        [_vm._v("\n            Create a group\n          ")]
                      )
                    ]
            ...
            _c(
              "span",
              { staticClass: "text-xl text-blue-600 ml-3 font-bold" },
              [_vm._v("To do")]
            )
          ]),
          _vm._v(" "),
          _vm._l(_vm.groups, function(group, groupKey) {
            return _c(
              "div",
              { key: groupKey },
              [
                group.name !== "default"
                  ? _c("div", { staticClass: "flex items-center pt-3" }, [
                      _c("div", { staticClass: "relative" }, [
                        _c(
                          "button",
                          {
                            ...
                            on: {
                              click: function($event) {
                                _vm.canShowGroupMenu =
                                  _vm.canShowGroupMenu === group.id
                                    ? false
                                    : group.id
                              }
                            }
                          ...
                          [
                            _c("icon", {
                              staticClass:
                                "block w-6 h-6 fill-current text-gray-500",
                              attrs: { name: "menu" }
                            })
                          ],
                          1
                          ...
                          ? _c(
                              ...
                              [
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "block w-full text-left px-4 py-2 text-gray-800 hover:bg-blue-500 hover:text-white",
                                    on: {
                                      click: function($event) {
                                        return _vm.showGroupEdit(group)
                                      }
                                    }
                                  },
                                  [
                      ...
                      _vm.canEditGroup === group.id
                        ? _c("input", {
                            ...
                            ref: "groupInput",
                            refInFor: true,
                            staticClass: "todo-form-input ml-3",
                            attrs: { type: "text" },
                        ...
                        : _c(
                            ...
                            {
                              staticClass:
                                "text-xl text-blue-600 ml-3 font-semibold"
                            },
                            [
                              _vm._v(
                                "\n          " +
                  ...
                  : _vm._e(),
                _vm._v(" "),
                _vm._l(group.todos, function(todo, key) {
                  return _c("div", { key: key }, [
                    _c("div", { staticClass: "flex items-center pt-3" }, [
                      ...
                      _c("input", {
                        ...
                        staticClass: "form-checkbox w-6 h-6 ml-2",
                        attrs: { type: "checkbox" },
                        domProps: {
                          value: todo.id,
                          checked: Array.isArray(_vm.checked)
                            ? _vm._i(_vm.checked, todo.id) > -1
                            : _vm.checked
                        },
                        on: {
                          click: function($event) {
                            ...
                            return _vm.editTodo(todo.id, { complete: true })
                          },
                      ...
                      _vm.canEditTodo === todo.id
                        ...
                        : _c("div", { staticClass: "text-lg ml-3 text-left" }, [
                            _vm._v(
                              "\n            " +
                                _vm._s(todo.name) +
                                "\n          "
                ...
                _vm.canCreateTodo === group.id
                  ? _c("input", {
                      ...
                      ref: "todoInput",
                      refInFor: true,
                      staticClass: "todo-form-input mt-2",
                      attrs: { type: "text" },
                      domProps: { value: _vm.todoName },
                      on: {
                        keyup: [
                          function($event) {
                            ...
                            return _vm.createTodo(group.id)
                          },
                          function($event) {
                            if (
                              !$event.type.indexOf("key") &&
                            ...
                            return _vm.createTodoAndOneMore(group.id)
                          },
                          function($event) {
                            if (
                              !$event.type.indexOf("key") &&
                  ...
                  : _c(
                      "button",
                      {
                        staticClass: "todo-form-button my-2",
                        on: {
                          click: function($event) {
                            return _vm.showTodoCreate(group.id)
                          }
                        }
                      },
                      [_vm._v("\n        Add a to-do\n      ")]
          ...
          _vm._v(" "),
          _vm.canCreateGroup
            ? _c("div", { staticClass: "w-full flex items-center mt-2" }, [
                _c("input", {
                  directives: [
                    {
                      name: "model",
            ...
            : _vm._e(),
          _vm._v(" "),
          _vm._l(_vm.completes, function(todo) {
            return _c("div", { key: todo.name + todo.id }, [
              todo.complete
                ? _c("div", { staticClass: "flex items-center pt-3" }, [
                    _c("input", {
                      staticClass: "form-checkbox w-6 h-6 ml-2",
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "text-lg ml-3" }, [
                      todo.group
                        ? _c("span", { staticClass: "font-semibold mr-1" }, [
                            _vm._v(
                              "\n            " +
                                _vm._s(todo.group.name) +
                                ":\n          "
                            )
                          ])
                        : _vm._e(),
                      _vm._v(" "),
                      _c("span", [_vm._v(_vm._s(todo.name))])
                    ])
                  ])
                : _vm._e()
            ])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _todos_vue_vue_type_template_id_0e23ef52___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todos.vue?vue&type=template&id=0e23ef52& */ "./resources/js/Components/todos.vue?vue&type=template&id=0e23ef52&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _todos_vue_vue_type_template_id_0e23ef52___WEBPACK_IMPORTED_MODULE_0__["render"],
  _todos_vue_vue_type_template_id_0e23ef52___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/***/ "./resources/js/Components/todos.vue?vue&type=template&id=0e23ef52&":
/*!**************************************************************************!*\
  !*** ./resources/js/Components/todos.vue?vue&type=template&id=0e23ef52& ***!
  \**************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_todos_vue_vue_type_template_id_0e23ef52___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./todos.vue?vue&type=template&id=0e23ef52& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Components/todos.vue?vue&type=template&id=0e23ef52&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_todos_vue_vue_type_template_id_0e23ef52___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_todos_vue_vue_type_template_id_0e23ef52___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
var Errors = /*#__PURE__*/function () {
  ...
  _createClass(Errors, [{
    ...
    value: function first() {
      ...
      var error = fields.find(function (field) {
        return _this3.has(field);
      });
...
/* harmony import */ var _vendor_tightenco_ziggy_src_js_route_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../vendor/tightenco/ziggy/src/js/route.js */ "./vendor/tightenco/ziggy/src/js/route.js");
...
vue__WEBPACK_IMPORTED_MODULE_3___default.a.use(_inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_1__["InertiaApp"]);

vue__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.$route = function () {
  return _vendor_tightenco_ziggy_src_js_route_js__WEBPACK_IMPORTED_MODULE_2__["default"].apply(void 0, arguments).url();
};
    ...
    return h(_inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_1__["InertiaApp"], {
      props: {
        ...
        resolveComponent: function resolveComponent(page) {
          return __webpack_require__(/*! ./Components/todos.vue */ "./resources/js/Components/todos.vue")["default"];
        },
        transformProps: function transformProps(props) {
          return _objectSpread(_objectSpread({}, props), {}, {
            errors: new _Utils_Errors__WEBPACK_IMPORTED_MODULE_0__["default"](props.errors)
          });
        }
      }
    });
...
__webpack_require__(/*! /home/y/code/packages/laravel-todos/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/y/code/packages/laravel-todos/resources/css/app.css */"./resources/css/app.css");
